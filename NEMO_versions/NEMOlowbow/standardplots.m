function standardplots(varargin)
...
figure(2)  %('Position',[100,100,1400,1050])
...
WormTraceFitting2D(folderName,ExcelFileName,name,numberofframes,fpst,segs,AvgVcm,AvgVh,Vcm)
