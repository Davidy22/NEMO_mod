function [COM1]=centerpoints1(s,COM1,pxpmm)

%Crops the XZ frame, based on the center point of the previous XZ frame.
%
%INPUTS:
%   s: frame number
%   COM1: coordinate of center point of previous XZ frame.
%   pxpmm: pixels per millimeter
%
%OUTPUTS:
%   COM1: coordinate of center point of current XZ frame.
...
fileName=['1_' int2str(s) '.png'];

disp(['Calculating centroids for frame ' int2str(s) ' for side1'])
...
for t=1:size1
   centerbydist=[centerbydist;[centerlist(t,1) centerlist(t,2) centerlist(t,3) ((centerlist(t,2)-COM1(1))^2+(centerlist(t,3)-COM1(2))^2)]];
end
